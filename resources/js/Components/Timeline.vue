...
const eventStyles = {
    ...
    card_reopened: { dot: 'bg-orange-500', ring: 'ring-orange-500/20' },
    card_blocked: { dot: 'bg-trello-red', ring: 'ring-trello-red/20' },
    card_unblocked: { dot: 'bg-emerald-400', ring: 'ring-emerald-400/20' },
